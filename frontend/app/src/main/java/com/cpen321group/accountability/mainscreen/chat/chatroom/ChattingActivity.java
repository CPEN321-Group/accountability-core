package com.cpen321group.accountability.mainscreen.chat.chatroom;
...
public class ChattingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSocket.connect();
        mSocket.emit("addUser", FrontendConstants.userID);
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!content.equals("")) {
                    ...
                    inputText.setText("");
                    mSocket.emit("sendMessage", FrontendConstants.userID, FrontendConstants.receiverID,content);
                    postMessage(content);
                }
            }
        });
            ...
            public void call(final Object... args) {
                ChattingActivity.this.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if(username.equals(FrontendConstants.receiverID)) {
    ...
    private void postMessage(String text){
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(FrontendConstants.baseURL + "/messaging/message/")
                ...
                try {
                    ...
                    if (jsonArray != null) {
                        for (int i = 0; i < jsonArray.size(); i++) {
                            ...
                            Log.d("hisId", hisId);
                            if (hisId.substring(1, hisId.length() - 1).equals(FrontendConstants.userID)) {
